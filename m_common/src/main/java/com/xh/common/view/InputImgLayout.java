...
public class InputImgLayout extends LinearLayout {
    ...
    public InputImgLayout(Context context, @Nullable AttributeSet attrs) {
        ...
        img = array.getResourceId(R.styleable.InputImgLayout_img, R.mipmap.ic_launcher);
        imgFocus = array.getResourceId(R.styleable.InputImgLayout_imgFocus, R.mipmap.ic_launcher);
        array.recycle();
