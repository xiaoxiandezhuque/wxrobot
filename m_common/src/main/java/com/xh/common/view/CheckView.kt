...
class CheckView(context: Context, attrs: AttributeSet?) : AppCompatImageView(context, attrs) {
    ...
    init {
        ...
        img = array.getResourceId(R.styleable.CheckView_imgNormal, R.mipmap.ic_launcher)
        imgCheck = array.getResourceId(R.styleable.CheckView_imgCheck, R.mipmap.ic_launcher)
        array.recycle()//回收
